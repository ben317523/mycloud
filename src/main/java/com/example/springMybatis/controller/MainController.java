...
public class MainController {
    ...
    public String logout(HttpServletResponse response) {
        ...
        return "<h1 style='margin: 0 auto;'>Log Out!</h1><script>setTimeout(function(){var backlen = history.length - sessionStorage.getItem(\"startLength\");sessionStorage.removeItem('startLength');alert('backlen : '+backlen);history.go(-backlen);},700)</script>";
    }
